...
target_sources(snapshot_test_support
    PRIVATE
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_cpu_context.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_cpu_context.h
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_exception_snapshot.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_exception_snapshot.h
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_memory_map_region_snapshot.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_memory_map_region_snapshot.h
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_memory_snapshot.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_memory_snapshot.h
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_module_snapshot.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_module_snapshot.h
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_process_snapshot.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_process_snapshot.h
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_system_snapshot.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_system_snapshot.h
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_thread_snapshot.cc
    ${CRASHPAD_SRC_DIR}/snapshot/test/test_thread_snapshot.h
)
...
target_sources(crashpad_snapshot_test PRIVATE
    ${CRASHPAD_SRC_DIR}/snapshot/cpu_context_test.cc
    ${CRASHPAD_SRC_DIR}/snapshot/memory_snapshot_test.cc
    ${CRASHPAD_SRC_DIR}/snapshot/minidump/process_snapshot_minidump_test.cc
)

if(APPLE)
    target_sources(crashpad_snapshot_test PRIVATE
        ${CRASHPAD_SRC_DIR}/snapshot/mac/cpu_context_mac_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/mac/mach_o_image_annotations_reader_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/mac/mach_o_image_reader_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/mac/mach_o_image_segment_reader_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/mac/process_reader_mac_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/mac/process_types_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/mac/system_snapshot_mac_test.cc
    )
endif()

if(UNIX AND NOT APPLE)
    target_sources(crashpad_snapshot_test PRIVATE
        ${CRASHPAD_SRC_DIR}/snapshot/linux/debug_rendezvous_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/linux/exception_snapshot_linux_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/linux/process_reader_linux_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/linux/system_snapshot_linux_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/sanitized/process_snapshot_sanitized_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/sanitized/sanitization_information_test.cc
    )
else()
    target_sources(crashpad_snapshot_test PRIVATE 
        ${CRASHPAD_SRC_DIR}/snapshot/crashpad_info_client_options_test.cc
    )
endif()

if(NOT APPLE)
    target_sources(crashpad_snapshot_test PRIVATE
        ${CRASHPAD_SRC_DIR}/snapshot/crashpad_types/crashpad_info_reader_test.cc
    )
endif()

if(WIN32)
    target_sources(crashpad_snapshot_test PRIVATE
        ${CRASHPAD_SRC_DIR}/snapshot/win/cpu_context_win_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/win/exception_snapshot_win_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/win/extra_memory_ranges_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/win/module_snapshot_win_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/win/pe_image_reader_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/win/process_reader_win_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/win/process_snapshot_win_test.cc
        ${CRASHPAD_SRC_DIR}/snapshot/win/system_snapshot_win_test.cc
    )
else()
    target_sources(crashpad_snapshot_test PRIVATE
        ${CRASHPAD_SRC_DIR}/snapshot/posix/timezone_test.cc
    )
endif()
...
add_library(crashpad_snapshot_test_module MODULE 
    ${CRASHPAD_SRC_DIR}/snapshot/crashpad_info_client_options_test_module.cc
)
...
add_library(crashpad_snapshot_test_module_large MODULE
    ${CRASHPAD_SRC_DIR}/snapshot/crashpad_info_size_test_module.cc
)
...
if(UNIX AND NOT APPLE)
    add_library(crashpad_snapshot_test_both_dt_hash_styles MODULE
        ${CRASHPAD_SRC_DIR}/snapshot/hash_types_test.cc
    )
...
if(APPLE)
    add_library(crashpad_snapshot_test_module_crashy_initializer MODULE
        ${CRASHPAD_SRC_DIR}/snapshot/mac/mach_o_image_annotations_reader_test_module_crashy_initializer.cc
    )
    ...
    add_executable(crashpad_snapshot_test_no_op
        ${CRASHPAD_SRC_DIR}/snapshot/mac/mach_o_image_annotations_reader_test_no_op.cc
    )
...
if(WIN32)
    add_executable(crashpad_snapshot_test_annotations
        ${CRASHPAD_SRC_DIR}/snapshot/win/crashpad_snapshot_test_annotations.cc
    )
    ...
    add_executable(crashpad_snapshot_test_crashing_child
        ${CRASHPAD_SRC_DIR}/snapshot/win/crashpad_snapshot_test_crashing_child.cc
    )
    ...
    add_executable(crashpad_snapshot_test_dump_without_crashing
        ${CRASHPAD_SRC_DIR}/snapshot/win/crashpad_snapshot_test_dump_without_crashing.cc
    )
    ...
    add_executable(crashpad_snapshot_test_extra_memory_ranges
        ${CRASHPAD_SRC_DIR}/snapshot/win/crashpad_snapshot_test_extra_memory_ranges.cc
    )
    ...
    add_executable(crashpad_snapshot_test_image_reader
        ${CRASHPAD_SRC_DIR}/snapshot/win/crashpad_snapshot_test_image_reader.cc
    )
    ...
    add_library(crashpad_snapshot_test_image_reader_module MODULE
        ${CRASHPAD_SRC_DIR}/snapshot/win/crashpad_snapshot_test_image_reader_module.cc
    )
